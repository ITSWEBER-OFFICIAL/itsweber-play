// Central icon library. We deliberately avoid emoji + avoid pulling in a
// 2-MB icon package; each glyph is a single Feather-style stroke path.
// Color comes from `currentColor` (inherits from text-*), stroke-width
// stays at 2 for visual consistency.
...
const PATHS: Record<IconName, React.ReactNode> = {
  ...
  tag: (
    <>
      <path d="M20.6 13.4L13 21l-8.5-8.5V4h8.5l7.6 7.6a1.4 1.4 0 0 1 0 2z" />
  ...
  flag: (
    <>
      <path d="M4 21V4a1 1 0 0 1 1-1h10l-2 4 2 4H5v10" />
    </>
  ),
  share: (
    <>
  ...
  link: (
    <>
      <path d="M10 13a5 5 0 0 1 7 7l-3 3" />
      <path d="M14 11a5 5 0 0 0-7-7l-3 3" />
      <path d="M8 12h8" />
    </>
  ),
  copy: (
  ...
  // ─── Brand icons (Simple Icons paths, MIT licence) ───────────────────
  "brand-x": (
    <path
      d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.737-8.835L1.254 2.25H8.08l4.261 5.633 5.901-5.633zm-1.161 17.52h1.833L7.084 4.126H5.117z"
      fill="currentColor"
      stroke="none"
    />
  ),
...
// Curated list of icons that work well as category glyphs — used by the
// admin category-UI as a pickable dropdown.
