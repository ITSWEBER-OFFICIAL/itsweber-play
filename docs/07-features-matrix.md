...
> Feature. Die High-Level-Roadmap steht in [09-roadmap.md](09-roadmap.md).
...
| Feature | Status | Version |
| --- | :-: | :-: |
| Per-Video OG-Tags + Twitter-Cards | ⬜ | v0.2 |
| Schema.org VideoObject JSON-LD | ⬜ | v0.2 |
| Sitemap + robots.txt | ⬜ | v0.2 |
| Share-Buttons (Copy/X/WhatsApp/Telegram/Mail) | ✅ | v0.2 |
| oEmbed-Endpoint | ⬜ | v0.3 |
| Embeddable Player `/embed/[slug]` | ⬜ | v0.3 |
...
| StaticPage-CMS (Admin-only Markdown-Pages) | ⬜ | v0.3 |
| Cookie-Consent-Banner (3-Stufen) | ⬜ | v0.3 |
| DSGVO-Export eigener Daten | ⬜ | v0.3 |
| DSGVO-Account-Löschung | ⬜ | v0.3 |
...
| Prod-Docker-Compose (Unraid-VLAN) | 🚧 | v0.3 |
| Prod-Deploy auf Unraid (echter Bau-Durchlauf) | ⬜ | v0.3 |
| NPM-Proxy-Konfig dokumentiert | ⬜ | v0.3 |
| Backup-Script (pg_dump + MinIO-rsync) | ✅ | v0.1 |
| GitHub-Repo public | ⬜ | v0.3 |
| GitHub-Actions CI (typecheck/lint/build) | ⬜ | v0.3 |
| Unraid Community Store | ⬜ | v0.3 |
...
| Feature | Status | Version |
| --- | :-: | :-: |
| itsweber.de Produktseite | ⬜ | v0.3 |
| Download-Bereich (Docker-Compose-Template) | ⬜ | v0.3 |
| Demo-Video | ⬜ | v0.3 |
| Screenshots + Feature-Matrix-Grafik | ⬜ | v0.3 |
...
| Progress-Log | ✅ | v0.1 |
| Installationsanleitung Unraid | ⬜ | v0.3 |
| Installationsanleitung generic Docker | ⬜ | v0.3 |
| Admin-Handbuch | ⬜ | v0.3 |
| Creator-Handbuch | ⬜ | v0.3 |
| GitHub-Wiki (10+ Seiten) | ⬜ | v0.3 |
